    ...
    <div>
        ...
        <div className="container-site">
          <div className="grid grid-cols-1 gap-8">
            {services.map(({ id, icon, title, tagline, desc, includes }, i) => (
              <div
                key={id}
                className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start rounded-2xl border border-white/5 p-8 hover:border-gold/20 transition-all"
                style={{ background: i % 2 === 0 ? 'rgba(27,43,75,0.3)' : 'rgba(17,30,44,0.5)' }}
              >
                <div>
                ...
                <div>
                  <h4 className="text-gold text-xs font-semibold tracking-widest mb-4">WHAT'S INCLUDED</h4>
      ...
      <section className="py-16 bg-navy-light text-center">
        <div className="container-site max-w-xl mx-auto">
          ...
          <p className="text-white/50 mb-8">Contact us to discuss which services best fit your real estate goals.</p>
