...
export default function About() {
  return (
    <div>
      ...
      <section className="py-16" style={{ background: '#1B2B4B', borderTop: '1px solid rgba(201,145,42,0.1)', borderBottom: '1px solid rgba(201,145,42,0.1)' }}>
        <div className="container-site">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[['12+', 'Properties Transformed'], ['$5M+', 'Portfolio Value'], ['100%', 'Quality Rate'], ['NY', 'Based & Serving']].map(([n, l]) => (
              <div key={l}>
                <div className="font-black text-4xl" style={{ color: '#C9912A' }}>{n}</div>
      ...
      <section className="py-20 text-center" style={{ background: '#080f18' }}>
        <div className="container-site max-w-xl mx-auto">
          <h2 className="text-white text-3xl font-black mb-4">Ready to Work Together?</h2>
          <p className="mb-8" style={{ color: 'rgba(255,255,255,0.5)' }}>Let's discuss how Nexus Growth Inc. can help with your real estate goals.</p>
